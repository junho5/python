...
while year<2016:
    bonus = doill * INTEREST_RATE
    doill += bonus
    year += 1
    # doill = doill * (1 + INTEREST_RATE) 요게더 깔끔

if doill>miran:
    print('{:.0f}원 차이로 동일 아저씨 말씀이 맞습니다.'.format(doill-miran))
else:
    print('{:.0f}원 차이로 미란 아줌마 말씀이 맞습니다}'.format(miran-doill))
